<%@ page import="com.ddbuy.ddbuy_protocal_web.util.PageUitl" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" language="JavaScript">
         function goPage(page){
             //var codition=$("#searchCodition").val();
             //location.href="http://localhost:8085/search?condtition=a&page=1";
             //alert("ddd");
            jq("#setPage").val(page);
             //alert(page);
             document.getElementById("seform1").submit();  //?
         }
    </script>
...
<div class="top">
    ...
    <div class="search">
        ...
        <form  id="seform1" method="get" action="search">
            <input type="text" name="condtition"  id="searchCodition" value="${condition}" class="s_ipt" />
            <input type="hidden" id="setPage" value="${page}" name="page"/>
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    <c:forEach items="${info.list}" var="p">
                        <li>
                            <div class="img"><a href="http://localhost:8086/${p.pid}.html">

                                <img src="images/default.jpg" width="210" height="185" />

                            </a></div>
                            <div class="price">
                                <font>￥<span>${p.price}</span></font> &nbsp;
                            </div>
                            <div class="name"><a href="http://localhost:8086/${p.pid}.html">${p.title}</a></div>
                            <div class="carbg">
                ...
                <div class="pages">
                    ${navigationBar}
                    <br/>
                    共${info.totalRecord}条记录，共${info.totalPage}页<br/>
