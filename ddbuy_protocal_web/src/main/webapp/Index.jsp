...
<script type="text/javascript">
    ...
    document.write("cookie:"+readCookie("token"));
    //发送异步请求获取用户展示
    //异步请求正常只能访问本系统的控制器返回json数据,访问别人系统的控制器返回json(跨域)
    jq.get("http://localhost:8087/getUsername",{"token":readCookie("token")},function(data){
       // alert(data.result);
        jq("#showName").text(data.result);
    },"json");
</script>
<!--Begin Header Begin-->
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
            <span class="fl"><span id="showName"></span>，请<a href="Login.html">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="search">
    	<form action="http://localhost:8085/search" target="_blank" method="get" name="dd">
        	<input type="text" name="condtition" value="" class="s_ipt" />
            ...
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                   <c:forEach items="${list}" var="l">
                    <li><img src="${l.pic}" width="740" height="401" /></li>
                   </c:forEach>
                </ul>
...
<div class="top">
    ...
    <div class="search">
        <form target="_blank" action="http://localhost:8085/search" method="get">
            <input txype="text" value="" name="condtition" class="s_ipt">
            <input type="submit" value="搜索" class="s_btn">
        </form>
        <span class="fl">
